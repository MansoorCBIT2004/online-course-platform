              ...
              <div className="row g-3">
                ...
                >
                  <Link
                    ...
                    to="/courses/mern"
                  >
                    <img className="img-fluid" src="/img/cat-1.jpg" alt="" loading="lazy" />
                    <div
                ...
                >
                  ...
                  >
                    <img className="img-fluid" src="/img/cat-2.jpg" alt="" loading="lazy" />
                    <div
                      className="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3"
                      style={{ margin: "1px" }}
                    >
                ...
                >
                  ...
                  >
                    <img className="img-fluid" src="/img/cat-3.jpg" alt="" loading="lazy" />
                    <div
                      className="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3"
                      style={{ margin: "1px" }}
                    >
