...
export default function Reactjs() {
    ...
    const courseHours = 4; // Estimated hours for this course
        ...
        if (isAuthenticated && user) {
            axios.get(`http://localhost:3000/progress/${user.sub}`)
                .then(res => {
                    ...
                    const isActive = res.data.activeCourses.includes('reactjs');
                    const isComp = res.data.completedCourses.includes('reactjs');
                    setIsCompleted(isComp);
                    if (!isActive && !isComp) {
                        // Add to active
                        const updated = { ...res.data, activeCourses: [...res.data.activeCourses, 'reactjs'] };
                    setProgress(updated);
    ...
    const markCompleted = () => {
        if (progress && !isCompleted) {
            const updated = {
                ...progress,
                completedCourses: [...progress.completedCourses, 'reactjs'],
                activeCourses: progress.activeCourses.filter(c => c !== 'reactjs'),
        ...
        <>
            ...
            <div className="container">
                ...
                <div className="row g-2 justify-content-center">
                    ...
                    <Coursecart link="https://www.youtube.com/embed/CgkZ7MvWUAA" title="01. What is React JS" desc="Introduction of React js." />
